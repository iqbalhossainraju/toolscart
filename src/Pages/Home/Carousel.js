...
const Carousel = () => {
    return (
        <>
            <div class="carousel w-full lg:h-96">
                <div id="slide1" class="carousel-item relative w-full" style={{ background: `url(${bg})`, backgroundSize: 'cover' }}>
                ...
                <div id="slide2" class="carousel-item relative w-full" style={{ background: `url(${bg})`, backgroundSize: 'cover' }}>
                    <div className="lg:ml-72 lg:mt-28 ml-5 uppercase">
                ...
                <div id="slide3" class="carousel-item relative w-full" style={{ background: `url(${bg})`, backgroundSize: 'cover' }}>
                    <div className="lg:ml-72 lg:mt-28 ml-5 uppercase">
                        <p className="lg:text-2xl text-xl font-bold">new in stock tools</p>
                        <h2 className="lg:text-4xl text-2xl text-primary font-bold my-2">super power drills</h2>
                        <p className="lg:text-xl">new arrival 2022</p>
